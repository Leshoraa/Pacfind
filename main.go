...
func main() {
	...
	flag.IntVar(&flagLimit, "l", 0, "Limit number of results per repository")
	flag.IntVar(&flagLimit, "limit", 0, "Limit number of results per repository")
	...
	ui.RenderResults(officialPkgs, aurPkgs, showOfficial, showAUR, flagLimit, aurErr)
}
